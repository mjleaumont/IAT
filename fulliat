	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Mentally Ill', //Will appear in the data and in the default feedback message.
				title : {
			...
			category2 :	{
				name : 'Physically Ill', //Will appear in the data and in the default feedback message.
				title : {
